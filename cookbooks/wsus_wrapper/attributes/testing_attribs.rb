...
node.override['wsus']['wsus_package_source']   = 'file://C:/local_binaries/wsus/WSUS30-KB972455-x64.exe'
...
node.override['wsus']['sp_package_source']   = 'file://C:/local_binaries/wsus/WSUS-KB2828185-amd64.exe'
node.override['wsus']['report_package_source'] = 'file://C:/local_binaries/wsus/ReportViewer.exe'
...
### Client overrides
node['wsus']['wsus_server_url'] = 'http://localhost:23456'